#Script that has to replace "lib/python3.10/site-packages/autogluon/tabular/trainer/auto_trainer.py" file of autogluon library, to solve the unhashable type "slice" error
import logging
    ...
    def fit(
        ...
        **kwargs,
        ...
        if display_all:
            ...
            for k in hyperparameters.keys():
                if isinstance(hyperparameters[k], list):
